...
<!-- <footer class="footer footer-static footer-light navbar-border navbar-shadow d-print-none">
    <div class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
        <span class="float-md-left d-block d-md-inline-block"><?php echo date('Y'); ?>  &copy; Copyright <a class="text-bold-800 grey darken-2" href="https://www.instagram.com/erd.bagus/" target="_blank">SEKARTAMA</a>
        </span>
